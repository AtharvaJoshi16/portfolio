...
export const Tab = ({
  ...
  return (
    <div className="w-full relative h-[70vh]">
      ...
      <div className="relative shadow-xl bg-gray-900 border border-gray-800  px-4 py-8 h-full overflow-y-scroll no-scrollbar rounded-2xl flex flex-col justify-start items-start">
