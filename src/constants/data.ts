...
export const Homepage = {
  ...
  RESUME_LINK:
    "https://firebasestorage.googleapis.com/v0/b/portfolio-1f6e3.appspot.com/o/AtharvaResumeLatestMar8.pdf?alt=media&token=f4ffaa1f-ab55-4385-97b1-9fa009886398",
  STATISTICS: {
    YOE: getYOE(),
    PROJECTS: {
      PROFESSIONAL: 3,
